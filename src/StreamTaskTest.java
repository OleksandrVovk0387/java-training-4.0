...
public class StreamTaskTest {
    ...
    public static Object[][] numbers() {
        return new Object[][]{
                ...
                {new int[]{0, 10, 20, 30}, 1400}, // Додано тест
                {new int[]{7, 8, 10, 2}, 168} // Додано тест
        };
    }
    ...
    public static Object[][] arrays() {
        return new Object[][]{
                ...
                {new int[]{9, 7, 15, 13, 1}, new int[]{1, 7, 9, 13, 15}}, // Додано тест
                {new int[]{2, 4, 6, 8}, new int[]{}} // Додано тест
        };
    }

    @Test(dataProvider = "numbers")
    public void testSumSquareEven(int[] numbers, int expectedResult) {
        // Перевірка суми квадратів парних чисел
        assertEquals(StreamTask.getSumSquareEven(numbers), expectedResult, "Sum is incorrect");
    }

    @Test(dataProvider = "arrays")
    public void testGetSortedOddsArray(int[] numbers, int[] expectedResult) {
        // Перевірка відсортованого масиву непарних чисел
